...
export default function RightNav() {
  return (
    <nav
      ...
      className="fixed right-0 top-0 h-screen w-28 bg-[#FFE48B] flex flex-col items-center py-6 z-50"
    >
      {/* Top icons */}
    ...
    case "Home":
      return (
        <svg
          ...
          stroke="currentColor"
        >
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10L12 3l9 7v10a1 1 0 01-1 1h-6v-6H10v6H4a1 1 0 01-1-1V10z"/>
        </svg>
      );
